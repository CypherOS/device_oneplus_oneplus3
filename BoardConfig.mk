...
TARGET_KERNEL_CONFIG := aoscp_oneplus3_defconfig
...
# Shims
TARGET_LD_SHIM_LIBS := /system/vendor/lib/hw/camera.msm8996.so|libcamera_shim.so:/system/lib/libFNVfbEngineHAL.so|libcamera_shim.so:/system/lib/libcamera_client.so|libcamera_parameters_shim.so
